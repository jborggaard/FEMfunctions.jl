...
""" =#
  ...
  if n == 2            
    ...
    ϕ_x[:,2] = (0.5/c0)*ones(Float64,size(r))
    ϕ_x[:,1] = -ϕ_x[:,2]
  ...
  elseif (n==4)
    ...
    ϕ[:,1] = -( 9.0/16.0).*( r3 .- r2      .- r./9.0 .+ 1.0/9.0 )
    ϕ[:,2] =  (27.0/16.0).*( r3 .- r2./3.0 .- r      .+ 1.0/3.0 )
    ϕ[:,3] = -(27.0/16.0).*( r3 .+ r2./3.0 .- r      .- 1.0/3.0 )
    ϕ[:,4] =  ( 9.0/16.0).*( r3 .+ r2      .- r./9.0 .- 1.0/9.0 )
 
    ϕ_x[:,1] = -( 9.0/16.0).*( 3.0.*r2 .-       2.0.*r .- 1.0/9.0 )./c0
    ϕ_x[:,2] =  (27.0/16.0).*( 3.0.*r2 .- (2.0/3.0).*r .- 1.0     )./c0
    ϕ_x[:,3] = -(27.0/16.0).*( 3.0.*r2 .+ (2.0/3.0).*r .- 1.0     )./c0
    ϕ_x[:,4] =  ( 9.0/16.0).*( 3.0.*r2 .+       2.0.*r .- 1.0/9.0 )./c0
 
    ϕ_xx[:,1] = -( 9.0/16.0).*( 6.0.*r .- 2.0     )./c0^2
    ϕ_xx[:,2] =  (27.0/16.0).*( 6.0.*r .- 2.0/3.0 )./c0^2
    ϕ_xx[:,3] = -(27.0/16.0).*( 6.0.*r .+ 2.0/3.0 )./c0^2
    ϕ_xx[:,4] =  ( 9.0/16.0).*( 6.0.*r .+ 2.0     )./c0^2
...
#=
  elseif (n==4)
    ...
    ϕ_r[:,1] = -( 9.0/16.0).*( 3.0.*r2 .-       2.0.*r .- 1.0/9.0 )
    ϕ_r[:,2] =  (27.0/16.0).*( 3.0.*r2 .- (2.0/3.0).*r .- 1.0     )
    ϕ_r[:,3] = -(27.0/16.0).*( 3.0.*r2 .+ (2.0/3.0).*r .- 1.0     )
    ϕ_r[:,4] =  ( 9.0/16.0).*( 3.0.*r2 .+       2.0.*r .- 1.0/9.0 )
 
    ϕ_rr[:,1] = -( 9.0/16.0).*( 6.0.*r .- 2.0     )
    ϕ_rr[:,2] =  (27.0/16.0).*( 6.0.*r .- 2.0/3.0 )
    ϕ_rr[:,3] = -(27.0/16.0).*( 6.0.*r .+ 2.0/3.0 )
    ϕ_rr[:,4] =  ( 9.0/16.0).*( 6.0.*r .+ 2.0     )
